<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-navbars.navs.auth titlePage="Add Stakeholder"></x-navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white mx-3">Add New Stakeholder</h6>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('stakeholder.store') }}" class="form-horizontal">
                                @csrf
                                <div class="form-group row">
                                    <label for="nama_atasan" class="col-1 control-label col-form-label">Nama Atasan</label>
                                    <div class="col-11">
                                        <input type="text" class="form-control" id="nama_atasan" name="nama_atasan" value="{{ old('nama_atasan') }}" required>
                                        @error('nama_atasan')
