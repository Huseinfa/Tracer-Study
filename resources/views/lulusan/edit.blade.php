                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('lulusan.update', $lulusan->id_lulusan) }}" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-11">
                                        <input type="text" class="form-control" id="email_lulusan" name="email_lulusan" value="{{ old('email_lulusan', $lulusan->email_lulusan) }}" required>
                                        @error('email_lulusan')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-11">
                                        <input type="text" class="form-control" id="no_hp_lulusan" name="no_hp_lulusan" value="{{ old('no_hp_lulusan', $lulusan->no_hp_lulusan) }}" required>
                                        @error('no_hp_lulusan')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
